...
!!! warning "Company Image"
    If you want to use a company image, make sure any processes that may interfere with web hosting or the other install processes is turned off.
...
Create the following A records in your DNS based on the values from the prerequisites.
...
- [DNS requirements](https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/installing_on_bare_metal/installing-bare-metal#installation-dns-user-infra_installing-bare-metal)
- [Validating DNS resolution for user-provisioned infrastructure](https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/installing_on_bare_metal/installing-bare-metal#installation-dns-user-infra_installing-bare-metal)
...
[Documentation for the firewall configuration](https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/installing_on_bare_metal/installing-bare-metal#configuring-firewall)

We will need access to the following for pulling OpenShift container images.
...
Make sure you have all of these installed and working:
